...
function fillText(text, x, y, color, fontSize) {
  ...
  if (typeof fontSize !== 'undefined') ctx.font = fontSize + 'px Atari';
...
function drawStartScreen() {
  ...
  fillCenteredText("Beat the master " + POINT_TO_BEAT + " points !", CANVAS_WIDTH/2, CANVAS_HEIGHT/2.75 + 200, '#FFFFFF', 36);
...
function animate() {
  ...
  if (player && player.score >= POINT_TO_BEAT) {
    localStorage.setItem("hasWonSpaceInvader", "true");
    document.getElementById("hasWon").style.display = 'block';
  }
